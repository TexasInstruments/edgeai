...
|---------------------------------------------------------|----------|--------|-----------------------|
| **Model training & associated tools**                   |[edgeai-modelzoo](https://github.com/TexasInstruments/edgeai-modelzoo)| **Model Zoo**<br>- To provide collection of pretrained models and documemtation|      |
|ditto                                                         |[Model optimization tools](https://github.com/TexasInstruments/edgeai-torchvision#guidelines-for-model-training--quantization)| **Model optimization tools** (QAT, Sparsity, Model surgery)<br>- [**QAT**: Quantization Aware Training](https://github.com/TexasInstruments/edgeai-torchvision/blob/master/docs/pixel2pixel/Quantization.md) to improve accuracy with fixed point training<br>- **Model surgery** [UPCOMING]: Modifies models with minimal loss in accuracy and makes it suitable for TI device (replaces unsupported operators)<br>- **Model sparsity** [UPCOMING]: Induces sparsity during training – only applicable for specific devices      |- Does not support Tensorflow   |

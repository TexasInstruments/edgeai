...
|---------------------------------------------------------|----------|-------|-----------------------|
| **Model training & associated tools**                   |[edgeai-modelzoo](https://github.com/TexasInstruments/edgeai-modelzoo)| **Model Zoo**<br>- To provide collection of pretrained models and |      |
